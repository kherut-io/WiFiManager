...
const char HTTP_STYLE[] PROGMEM           = "<style>html{height: 100%;}.logo{margin-top: 10px }.c, body{text-align: center;height: 100%;}body,button{font-family: monospace;cursor: pointer;}form{margin-top: 15px;}form:first-of-type{margin-top: 10px;}h1{margin-top: 25px;}.option{display: inline-block;width: 310px;}div,input{padding: 5px;font-size: 1em }input{width: 270px;height: 35px;border: none;border: solid 1px black;border-radius: 25px;margin-top: 7px;outline: none;padding: 5px 20px;font-family: monospace;}button[type='submit']{width: 310px;}body{background: #fff;color: #000;margin: 0;background-repeat: no-repeat;background-attachment: fixed;}button{border-radius: 21px;background-color: transparent;color: black;border: solid 1px black;height: 42px;font-size: 12px;width: 100%;transition: 0.2s ease-out all;}button:hover{color: white;background: black;}.scan_link a{color: black;text-decoration: none;font-size: 32px;position: absolute;top: 0;left: 14px;font-family: monospace;}.wifi_link *{display: inline-block;margin-bottom: 10px;}.wifi_link a{color: black;text-decoration: none;}.wifi_link:first-of-type{margin-top: 20px;}dl{position: absolute;text-align: left;left: 50%;transform: translateX(-50%);font-size: 14px;margin-top: 20px;}dl dt{font-weight: bolder;}dl dt::after{content: ':';}dl dd{margin-bottom: 10px;}.wifi_link::after{content: '';display: block;width: 50px;height: 1px;background: black;margin: auto;}.wifi_link:nth-last-of-type(2)::after{display: none;}.l {color: black;}.logo{background: url('data:image/png;base64,') left center no-repeat;background-size: 1em;-webkit-filter: invert(100%);-ms-filter: invert(100%);filter: invert(100%);}</style>";
